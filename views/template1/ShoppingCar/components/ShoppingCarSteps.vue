<template>
    <div class="relative">
        <ul class="flex justify-center text-center mt-[60px]">
            <li
        ...
        <div class="absolute w-[420px] z-[-1] top-[18px] flex justify-center h-[72px]">
            <div class="w-[300px] bg-gray-300 h-[1px] mx-auto"></div>
        </div>
    </div>
</template>

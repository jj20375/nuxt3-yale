        ...
        <template #content>
            <div class="max-w-[800px] mx-auto mt-[80px]">
                ...
                <div class="edit-section">
                    <NuxtImg
                        class="w-full"
                        src="/img/reservation/reservation-process.jpg"
                    />
                    <h3 class="font-medium text-[18px] YaleSolisW-Bd mt-[36px] mb-[12px]">服務保證範圍</h3>
                    <p>
                        ...
                        保固起算日期將採以下任一方式認定：<br />1. 有效保證卡之留存聯（加蓋經銷店章及註明購買日期）<br />2. 購買憑證（發票、收據等）正本或影本 若無以上資料者，則依照產品主機上之機號(製造號碼，第一碼為製造年份，第二與第三碼為製造週別)往後推算三個月做為保固起算日期
                    </p>
                </div>

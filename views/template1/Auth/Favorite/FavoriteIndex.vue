...
async function getList() {
    try {
        ...
        rows.forEach((item: { id: any; model: any; name: any; shape: any; price: any; market_price: any; main_image: any; other_images: any; is_favorite: boolean; is_single_variation: boolean; seoSetting: any }) => {
            datas.value.push({
                id: item.id,
                model: item.model,
                name: item.name,

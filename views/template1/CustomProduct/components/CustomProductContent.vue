<template>
    <div>
        ...
        <div class="mt-[20px] flex cursor-pointer" @click="handleProcess">
            <NuxtImg
                class="w-[16px] mr-[9px]"
                src="/img/custom-product/custom-product-learn-more-icon.svg"
            />
            <p class="text-gray-800 text-[15px]">了解訂製流程</p>
        </div>
        <el-dialog
        ...
        >
            ...
            <div class="text-gray-800 edit-section" v-html="processData.content"></div>
        </el-dialog>
    </div>
</template>

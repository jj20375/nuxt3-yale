...
export default () => {
    ...
    return {
        ...
        FacebookOauthUnbindAPI() {
            return useMyFetch(`${apiNestJsUrl}/auth/facebook-oauth2-unbind`, { method: "post" });
        },
        ...
        GoogleOauthUnbindAPI() {
            return useMyFetch(`${apiNestJsUrl}/auth/google-oauth2-unbind`, { method: "post" });
        },
         ...
         * }
         */
        GoogleOauthBindAPI(data: { access_token: string; phone: string; device: string }) {
            return useMyFetch(`${apiNestJsUrl}/auth/google-oauth2-bind`, { method: "post", body: { ...data, device: "web" } });
        },
        ...
        GoogleLoginAPI(data: { access_token: string }) {
            return useMyFetch(`${apiNestJsUrl}/auth/google-oauth2-login`, { method: "post", body: { ...data, device: "web" } });
        },
        ...
        GoogleOauthRegisterAPI(data: any) {
            return useMyFetch(`${apiNestJsUrl}/auth/google-oauth2-register`, { method: "post", body: data });
        },
        ...
        LineTokenAPI(params: { code: string; redirect_uri: string }) {
            console.log("line token api => ", `${apiUrl}/auth/line-token?${qs.stringify(params)}`);
            return useMyFetch(`${apiUrl}/auth/line-token?${qs.stringify(params)}`, { method: "get" });
        },
        ...
        LineOauthBindAPI(data: { access_token: string; phone: string }) {
            return useMyFetch(`${apiNestJsUrl}/auth/line-oauth2-bind`, { method: "post", body: data });
        },
         ...
         */
        LineOauthUnbindAPI() {
            return useMyFetch(`${apiNestJsUrl}/auth/line-oauth2-unbind`, { method: "post" });
        },
        ...
        LineOauthRegisterAPI(data: any) {
            return useMyFetch(`${apiNestJsUrl}/auth/line-oauth2-register`, { method: "post", body: data });
        },
        ...
        Axios_LineUserProfileAPI(form: { id_token: string; client_id: string }) {
            ...
            return axios.post("https://api.line.me/oauth2/v2.1/verify", qs.stringify(form), {
                headers: {
        ...
        async AppleLoginAPI(data: { id_token: string }) {
            return useMyFetch(`${apiNestJsUrl}/auth/apple-oauth2-login`, { method: "post", body: data, server: false });
        ...
        AppleOauthBindAPI(data: { id_token: string; phone: string }) {
            return useMyFetch(`${apiNestJsUrl}/auth/apple-oauth2-bind`, { method: "post", body: data });
        },
         ...
         */
        AppleOauthUnbindAPI() {
            return useMyFetch(`${apiNestJsUrl}/auth/apple-oauth2-unbind`, { method: "post" });
        },
        ...
        AppleOauthRegisterAPI(data: any) {
            return useMyFetch(`${apiNestJsUrl}/auth/apple-oauth2-register`, { method: "post", body: data });
        },
    };
};
